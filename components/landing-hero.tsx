    ...
    <div className="text-white font-bold py-36 text-center space-y-5 grid place-items-center">
      ...
      <div className="text-[#FEFEFF] p-2 font-lota">
        <TypewriterComponent
          options={{
            ...
            autoStart: true,
            loop: true,
            wrapperClassName: ` tracking-wide text-[80px] md:text-[40]`,
          }}
        />
      </div>

      <div
        className={`text-lg md:text-xl  text-zinc-400 font-extrabold font-lota `}
      >
      ...
      <div>
        <Link href={isSignedIn ? "/dashboard" : "/sign-up"}>
          <Button
            variant="secondary"
            className={`  md:text-lg sm:text-sm lg:text-xl p-3 md:p-4 lg:p-6 rounded-xl font-lota  text-black bg-white bg-gradient-to-br  hover:from-[#C53678] hover:via-[#F79C1A] hover:to-[#7C408A] hover:text-black hover:font-extrabold `}
          >
